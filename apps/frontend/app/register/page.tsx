        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-500 outline-none focus:ring-2 focus:ring-blue-500"
